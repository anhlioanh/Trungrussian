...
const PHRASES = [
  ...
  { ru: 'Со́ня!', vn: 'Đồ ngủ nướng!', cat: 'tease', lv: 'a2',
  ...
  /* ---------- CÂU CỬA MIỆNG (bổ sung) ---------- */
  { ru: 'Мо́жет быть.', vn: 'Có thể.', cat: 'song', lv: 'a2', when: 'Trả lời nước đôi khi chưa chắc chắn.' },
  { ru: 'Наве́рное.', vn: 'Chắc là vậy.', cat: 'song', lv: 'a2', when: 'Chắc hơn «может быть» một chút, kiểu "chắc thế".' },
  { ru: 'Коне́чно, нет!', vn: 'Tất nhiên là không rồi!', cat: 'song', lv: 'a2', when: 'Phủ định dứt khoát nhưng thân mật.' },
  { ru: 'Я так и ду́мал.', vn: 'Tôi đã nghĩ vậy mà.', cat: 'song', lv: 'b1', when: 'Khi chuyện xảy ra đúng như mình đoán. Con gái nói «думала».' },
  { ru: 'Не мо́жет быть!', vn: 'Không thể nào!', cat: 'song', lv: 'a2', when: 'Ngạc nhiên mạnh, không tin nổi.' },
  { ru: 'Что случи́лось?', vn: 'Có chuyện gì vậy?', cat: 'song', lv: 'a2', when: 'Hỏi khi thấy ai đó có vẻ không ổn.' },
  { ru: 'Всё равно́.', vn: 'Sao cũng được. / Dù sao thì.', cat: 'song', lv: 'b1', when: 'Hai nghĩa tuỳ ngữ cảnh: "tôi không quan tâm cái nào" hoặc "dù sao đi nữa".' },
  { ru: 'На вся́кий слу́чай.', vn: 'Cho chắc ăn.', cat: 'song', lv: 'b1', when: 'Giải thích lý do làm thêm việc gì đó phòng xa.' },
  { ru: 'Мне всё равно́.', vn: 'Tôi thấy sao cũng được.', cat: 'song', lv: 'a2', when: 'Cẩn thận: nói cụt lủn quá dễ bị hiểu là "tôi chẳng quan tâm", nghe lạnh.' },
  { ru: 'Дава́й посмо́трим.', vn: 'Để xem sao đã.', cat: 'song', lv: 'a2', when: 'Chưa quyết ngay, để tính sau.' },
  { ru: 'Как хо́чешь.', vn: 'Tuỳ cậu.', cat: 'song', lv: 'a2', when: 'Nhường quyền quyết định. Nói với giọng cụt thì thành dỗi.' },
  { ru: 'Ты прав.', vn: 'Cậu nói đúng.', cat: 'song', lv: 'a2', when: 'Công nhận người kia đúng. Con gái thì nói «Ты права».' },
  { ru: 'Я согла́сен.', vn: 'Tôi đồng ý.', cat: 'song', lv: 'a2', when: 'Con gái nói «Я согласна». Dùng được cả trong họp hành lẫn nói chuyện thường.' },
  { ru: 'Мне ка́жется…', vn: 'Tôi thấy hình như…', cat: 'song', lv: 'b1', when: 'Mở đầu khi nêu ý kiến nhẹ nhàng, không áp đặt. Rất hay dùng khi tranh luận lịch sự.' },
  { ru: 'Че́стно говоря́,', vn: 'Nói thật thì,', cat: 'song', lv: 'b1', when: 'Mở đầu khi sắp nói điều gì đó thẳng thắn.' },
  { ru: 'К сожале́нию,', vn: 'Tiếc là,', cat: 'song', lv: 'a2', when: 'Mở đầu tin không vui. Dùng được cả trong thư từ trang trọng.' },
  { ru: 'Ничего́ стра́шного.', vn: 'Không có gì đâu. / Không sao.', cat: 'song', lv: 'a2', when: 'Trấn an khi ai đó xin lỗi hoặc lo lắng. Câu cực kỳ hay dùng.' },
  { ru: 'С удово́льствием!', vn: 'Rất sẵn lòng!', cat: 'song', lv: 'a2', when: 'Nhận lời mời một cách vui vẻ. Lịch sự và ấm áp.' },

  /* ---------- NÓI KHÁC VIẾT (bổ sung) ---------- */
  { ru: 'то́ка', vn: 'chỉ (dạng nói của «то́лько»)', cat: 'speak', lv: 'b1', when: 'Chỉ để nghe hiểu, đừng viết ra.' },
  { ru: 'када́', vn: 'khi nào (dạng nói của «когда́»)', cat: 'speak', lv: 'b1', when: 'Nghe trong lời nói nhanh, thân mật. Viết thì luôn là «когда».' },
  { ru: 'спаси́б', vn: 'cảm ơn (dạng rút của «спаси́бо»)', cat: 'speak', lv: 'a1', when: 'Nói nhanh giữa bạn bè hay nuốt mất chữ cuối.' },
  { ru: 'норм', vn: 'ổn (dạng rút của «норма́льно»)', cat: 'speak', lv: 'b1', when: 'Ngôn ngữ tin nhắn của người trẻ. Đừng dùng khi nói với thầy cô.' },
  { ru: 'приве́тик', vn: 'chào nhé (dạng thân mật của «приве́т»)', cat: 'speak', lv: 'a1', when: 'Đuôi -ик làm câu chào dễ thương hơn. Con gái dùng nhiều hơn.' },
  { ru: 'Ты где?', vn: 'Cậu đang ở đâu?', cat: 'speak', lv: 'a1', when: 'Trong nói chuyện, người Nga hay bỏ động từ: «Ты где?» thay vì «Где ты находишься?».' },
  { ru: 'Пошли́!', vn: 'Đi thôi!', cat: 'speak', lv: 'a2', when: 'Rủ đi cùng, thân mật. Trang trọng hơn thì «Пойдёмте».' },
  { ru: 'Сейча́с приду́.', vn: 'Tôi đến ngay đây.', cat: 'speak', lv: 'a2', when: 'Ngoài đời nghe thành «Щас приду». Nghĩa là "chờ tí".' },
  { ru: 'Ну и что?', vn: 'Thì sao?', cat: 'speak', lv: 'b1', when: 'Phản ứng khi không thấy chuyện đó quan trọng. Giọng gắt thì thành thách thức.' },
  { ru: 'Да нет, наве́рное.', vn: 'Ừ thì… chắc là không.', cat: 'speak', lv: 'b2', when: 'Câu nổi tiếng khó dịch: có cả «да», «нет» và «наверное» trong một câu, nhưng nghĩa là "chắc là không". Người Nga dùng thật, không phải chuyện đùa.' },

  /* ---------- LỖI NGƯỜI VIỆT HAY MẮC (bổ sung) ---------- */
  { ru: 'Я иду́ домо́й.', bad: 'Я иду́ в дом.', vn: 'Tôi đang về nhà.', cat: 'error', lv: 'a1',
    when: '«Домой» là một trạng từ riêng nghĩa "về nhà", không dùng giới từ. Tương tự «дома» = "ở nhà".' },
  { ru: 'Я живу́ во Вьетна́ме.', bad: 'Я живу́ в Вьетна́м.', vn: 'Tôi sống ở Việt Nam.', cat: 'error', lv: 'a1',
    when: 'Chỉ nơi CHỐN thì dùng cách 6: Вьетнам → во Вьетнаме. Và trước chữ В thì «в» đổi thành «во» cho dễ đọc.' },
  { ru: 'Ей два́дцать лет.', bad: 'Она́ два́дцать лет.', vn: 'Cô ấy hai mươi tuổi.', cat: 'error', lv: 'a1',
    when: 'Nói tuổi thì người phải ở cách 3: она → ей. Không có động từ "là".' },
  { ru: 'У меня́ боли́т голова́.', bad: 'Я боле́ю го́лову.', vn: 'Tôi đau đầu.', cat: 'error', lv: 'a2',
    when: 'Bộ phận cơ thể mới là chủ ngữ: "cái đầu đang đau ở chỗ tôi". «Болеть» kiểu kia nghĩa là "bị bệnh nói chung".' },
  { ru: 'Я жду тебя́.', bad: 'Я жду для тебя́.', vn: 'Tôi đang đợi bạn.', cat: 'error', lv: 'a2',
    when: '«Ждать» đi thẳng với cách 4, không cần giới từ. Đừng bê chữ "for" của tiếng Anh vào.' },
  { ru: 'Я говорю́ по-ру́сски.', bad: 'Я говорю́ ру́сский.', vn: 'Tôi nói tiếng Nga.', cat: 'error', lv: 'a1',
    when: 'Nói MỘT NGÔN NGỮ thì dùng dạng «по-русски», «по-вьетнамски». Còn «русский язык» chỉ dùng khi nói VỀ ngôn ngữ đó.' },
  { ru: 'Э́то мой друг.', bad: 'Э́тот мой друг.', vn: 'Đây là bạn tôi.', cat: 'error', lv: 'a1',
    when: 'Khi giới thiệu "đây là…" thì luôn dùng «Это», bất kể giống gì. «Этот» nghĩa là "cái/người này" đứng trước danh từ.' },
  { ru: 'Я хожу́ в университе́т ка́ждый день.', bad: 'Я иду́ в университе́т ка́ждый день.', vn: 'Ngày nào tôi cũng đến trường.', cat: 'error', lv: 'a2',
    when: 'Việc lặp đi lặp lại thì dùng «ходить». «Идти» là đang đi ngay lúc này, một lần, một chiều.' },
  { ru: 'Мне ну́жно рабо́тать.', bad: 'Я ну́жно рабо́тать.', vn: 'Tôi cần phải làm việc.', cat: 'error', lv: 'a2',
    when: '«Нужно/надо» đi với cách 3: мне, тебе, ему. Nếu muốn dùng «я» thì phải đổi câu thành «Я должен работать».' },
  { ru: 'Спаси́бо за по́мощь.', bad: 'Спаси́бо для по́мощь.', vn: 'Cảm ơn vì đã giúp.', cat: 'error', lv: 'a2',
    when: 'Cảm ơn VÌ việc gì thì dùng «за» + cách 4, không dùng «для».' },
  { ru: 'Я не зна́ю, где он.', bad: 'Я не зна́ю где он?', vn: 'Tôi không biết anh ấy ở đâu.', cat: 'error', lv: 'a2',
    when: 'Câu hỏi nằm trong câu kể thì không có dấu hỏi và giữ nguyên trật tự, không đảo như câu hỏi thật.' },
  { ru: 'В про́шлом году́ я был в Москве́.', bad: 'В про́шлый год я был в Москве́.', vn: 'Năm ngoái tôi đã ở Moskva.', cat: 'error', lv: 'b1',
    when: 'Cụm chỉ thời gian «в прошлом году», «в этом году» dùng cách 6 chứ không phải cách 4.' },

  /* ---------- THÀNH NGỮ (bổ sung) ---------- */
  { ru: 'Как об сте́нку горо́х.', vn: 'Nước đổ đầu vịt.', cat: 'idiom', lv: 'b2', when: 'Nói mãi mà người ta không nghe.' },
  { ru: 'Рабо́та не волк, в лес не убежи́т.', vn: 'Việc có chạy đi đâu mà vội.', cat: 'idiom', lv: 'b2', when: 'Câu đùa quen thuộc khi ai đó muốn hoãn việc lại. Nói vui thôi.' },
  { ru: 'Пе́рвый блин ко́мом.', vn: 'Vạn sự khởi đầu nan.', cat: 'idiom', lv: 'b1', when: 'An ủi khi lần đầu làm gì đó chưa tốt. Nghĩa đen: cái bánh xèo đầu tiên bao giờ cũng hỏng.' },
  { ru: 'Не всё то зо́лото, что блести́т.', vn: 'Không phải cái gì lấp lánh cũng là vàng.', cat: 'idiom', lv: 'b1', when: 'Cảnh báo đừng nhìn vẻ ngoài mà đánh giá.' },
  { ru: 'Век живи́ — век учи́сь.', vn: 'Học, học nữa, học mãi.', cat: 'idiom', lv: 'b1', when: 'Nói khi vừa học được điều gì mới, kể cả khi đã lớn tuổi.' },
  { ru: 'Лу́чше по́здно, чем никогда́.', vn: 'Muộn còn hơn không.', cat: 'idiom', lv: 'a2', when: 'Khi ai đó làm việc gì muộn nhưng vẫn làm.' },
  { ru: 'Куй желе́зо, пока́ горячо́.', vn: 'Việc hôm nay chớ để ngày mai.', cat: 'idiom', lv: 'b2', when: 'Khuyên nắm lấy cơ hội khi còn kịp.' },
  { ru: 'В гостя́х хорошо́, а до́ма лу́чше.', vn: 'Ta về ta tắm ao ta.', cat: 'idiom', lv: 'b1', when: 'Nói khi vừa đi xa về. Rất hợp với tâm trạng du học sinh.' },
  { ru: 'Дру́жба дру́жбой, а слу́жба слу́жбой.', vn: 'Bạn là bạn, việc là việc.', cat: 'idiom', lv: 'b2', when: 'Tách bạch chuyện tình cảm và chuyện công việc.' },
  { ru: 'Го́лод не тётка.', vn: 'Đói thì đầu gối phải bò.', cat: 'idiom', lv: 'b2', when: 'Nói vui khi đói quá phải ăn tạm gì đó.' },

  /* ---------- TRÊU NHAU (bổ sung) ---------- */
  { ru: 'Ты чего́ тако́й серьёзный?', vn: 'Sao mặt nghiêm trọng thế?', cat: 'tease', lv: 'b1', when: 'Chọc bạn đang cau có. Con gái thì «такая серьёзная».' },
  { ru: 'Не выпе́ндривайся!', vn: 'Đừng làm màu!', cat: 'tease', lv: 'b1', when: 'Trêu bạn đang khoe. Thân mật, chỉ với bạn thân.' },
  { ru: 'Ну ты и хитре́ц!', vn: 'Cậu ranh thật đấy!', cat: 'tease', lv: 'b1', when: 'Nửa khen nửa trêu khi ai đó lách được việc gì khéo. Con gái là «хитрюга».' },
  { ru: 'Я тебя́ умоля́ю!', vn: 'Thôi đi ông ơi!', cat: 'tease', lv: 'b2', when: 'Bác bỏ đùa khi nghe điều gì quá đáng. Nghĩa đen là "tôi van cậu".' },
  { ru: 'Расска́зывай!', vn: 'Kể tiếp đi! / Xạo!', cat: 'tease', lv: 'b1', when: 'Tuỳ giọng: hoặc là "kể đi", hoặc là "thôi bịa vừa thôi".' },
  { ru: 'Вот э́то да!', vn: 'Ghê thật đấy!', cat: 'tease', lv: 'a2', when: 'Thán phục, có thể thật lòng hoặc trêu.' },
  { ru: 'Ты меня́ уби́л.', vn: 'Cậu làm tôi chết cười.', cat: 'tease', lv: 'b2', when: 'Khẩu ngữ, khi bạn nói gì đó quá buồn cười. Con gái nói «убила».' },
  { ru: 'Спаси́бо, кэп!', vn: 'Cảm ơn nhé, thánh hiển nhiên!', cat: 'tease', lv: 'b2', when: 'Mỉa khi ai đó nói ra điều quá hiển nhiên. «Кэп» từ "Captain Obvious", ngôn ngữ mạng.' },

  /* ---------- SỐNG Ở NGA (bổ sung) ---------- */
  { ru: 'Ско́лько с меня́?', vn: 'Tôi phải trả bao nhiêu?', cat: 'life', lv: 'a2', when: 'Hỏi tiền ở quán, taxi. Gọn và rất tự nhiên.' },
  { ru: 'Мо́жно пакет?', vn: 'Cho tôi xin cái túi được không?', cat: 'life', lv: 'a1', when: 'Ở siêu thị Nga túi thường phải mua thêm, không cho sẵn.' },
  { ru: 'У вас есть сда́ча?', vn: 'Anh/chị có tiền lẻ trả lại không?', cat: 'life', lv: 'a2', when: 'Khi đưa tờ tiền to.' },
  { ru: 'Где ближа́йшая апте́ка?', vn: 'Hiệu thuốc gần nhất ở đâu?', cat: 'life', lv: 'a2', when: 'Câu hỏi đường mẫu — thay «аптека» bằng nơi khác là dùng được ngay.' },
  { ru: 'Мне ну́жно к врачу́.', vn: 'Tôi cần đi khám bác sĩ.', cat: 'life', lv: 'a2', when: 'Ở ký túc xá hoặc phòng y tế trường.' },
  { ru: 'Я потеря́л докуме́нты.', vn: 'Tôi bị mất giấy tờ.', cat: 'life', lv: 'b1', when: 'Câu quan trọng phải thuộc. Con gái nói «потеряла».' },
  { ru: 'Как дое́хать до це́нтра?', vn: 'Đi vào trung tâm thế nào ạ?', cat: 'life', lv: 'a2', when: '«Доехать» là đi bằng xe; đi bộ thì hỏi «Как дойти до…».' },
  { ru: 'Э́то ме́сто свобо́дно?', vn: 'Chỗ này có ai ngồi chưa ạ?', cat: 'life', lv: 'a2', when: 'Trên tàu, trong quán ăn, trong thư viện.' },
  { ru: 'Извини́те за беспоко́йство.', vn: 'Xin lỗi đã làm phiền.', cat: 'life', lv: 'b1', when: 'Mở đầu lịch sự khi nhờ vả ai đó, nhất là thầy cô qua email.' },
  { ru: 'Мо́жно с ва́ми сфотографи́роваться?', vn: 'Cháu chụp ảnh với cô/chú được không ạ?', cat: 'life', lv: 'b1', when: 'Câu lịch sự đúng chuẩn khi xin chụp ảnh cùng ai.' },
  { ru: 'Я учу́сь на пе́рвом ку́рсе.', vn: 'Em học năm thứ nhất.', cat: 'life', lv: 'a2', when: '«Курс» là năm học đại học. Người Nga hỏi «На каком курсе?» chứ không hỏi "năm mấy".' },
  { ru: 'Я в общежи́тии живу́.', vn: 'Em ở ký túc xá.', cat: 'life', lv: 'a2', when: '«Общага» là cách gọi thân mật của sinh viên, dùng với bạn bè thì được.' }
];
